...
public class TypeOfError {
    ...
    public static final Errors BANK_CODE_INVALID = new Errors("GP-003", "Invalid bank code");
    ...
    public static final Errors EFFECTIVE_DATE_MUST_BE_BEFORE_EXPIRED_DATE = new Errors("GP-006", "effectiveDate must be before expiredDate");
